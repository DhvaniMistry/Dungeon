...
#define charpair(pair) (d->character_loc[pair[dim_y]][pair[dim_x]])
#define charxy(x, y) (d->character_loc[y][x])
...
typedef struct dungeon {
  ...
  character *character_loc[DUNGEON_Y][DUNGEON_X];
  character pc;
  heap_t events;
  ...
  uint32_t is_new;
  uint32_t quit;
  char map_in_sight[DUNGEON_Y][DUNGEON_X];
} dungeon_t;
